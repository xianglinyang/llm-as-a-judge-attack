...
class ContextualLinEpsilonGreedyAgent(ContextualLinBanditAgent):
    def __init__(self, n_features: int, llm_agent: BaseLLM, embedding_model: TextEncoder, judge_type: JudgeType, judge_model_backbone: str, reward_type: str = "relative", epsilon: float = 0.1, lambda_reg: float = 1.0, answer_position: str = "first"):
        """
