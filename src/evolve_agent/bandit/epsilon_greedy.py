...
if __name__ == "__main__":
    ...
    agent = ContextualLinEpsilonGreedyAgent(args.epsilon, args.n_features, llm_agent, embedding_model, llm_evaluator, args.reward_type, args.lambda_reg)
    ...
    save_path = os.path.join(args.save_trajectory_path, f"epsilon_greedy_{args.test_mode}_{args.dataset_name}_{timestamp}.json")
    with open(save_path, "w") as f:
